...
unzip -l dist/web-store/brw-extension-0.7.5.zip
```
...
|---|---|---|
| Package | Current ZIP, manifest at root | `dist/web-store/brw-extension-0.7.5.zip` |
...
4. Upload `dist/web-store/brw-extension-0.7.5.zip` to the matching draft item.
