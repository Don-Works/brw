...
unzip -l dist/web-store/brw-extension-0.4.15.zip
```
...
|---|---|---|
| Package | Current ZIP, manifest at root | `dist/web-store/brw-extension-0.4.15.zip` |
...
4. Upload `dist/web-store/brw-extension-0.4.15.zip` to the matching draft item.
