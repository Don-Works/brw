...
unzip -l dist/web-store/brw-extension-0.7.3.zip
```
...
|---|---|---|
| Package | Current ZIP, manifest at root | `dist/web-store/brw-extension-0.7.3.zip` |
...
4. Upload `dist/web-store/brw-extension-0.7.3.zip` to the matching draft item.
