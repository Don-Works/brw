...
unzip -l dist/web-store/brw-extension-0.7.0.zip
```
...
|---|---|---|
| Package | Current ZIP, manifest at root | `dist/web-store/brw-extension-0.7.0.zip` |
...
4. Upload `dist/web-store/brw-extension-0.7.0.zip` to the matching draft item.
